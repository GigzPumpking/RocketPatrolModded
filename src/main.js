...
5 pt: Allow player to control rocket after being fired: All I did was remove the isFiring lock, but I did increase the speed of horizontal movement after being fired.

10 pt: 4 new explosion sound effects, made using jsfxr. The sfx are randomized.
10 pt: Time displayed in seconds (the first 10 seconds display a decimal, could not remove at the time being)
